...
public class GameController : NetworkBehaviour
{
    ...
    private void OnPositionsChanged(SyncListPositions.Operation op, int index, Position pos)
    {
    ...
    private void OnLinesChanged(SyncListLines.Operation op, int index, Line line)
    {
    ...
    public void SaveCSV()
    {
        ...
        writer.Flush();
        writer.Close();
        fileControl.scene = SceneCase.GameController;
